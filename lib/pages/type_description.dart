              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    BouncingAnim(
                      onPress: (){
                        Utils.push(context, AllAudios(languageId));
                      },
                      child: Container(
                        width: 40.w,
                        height: 40.w,
                        child: Neumorphic(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children:  [
                                Icon(Icons.audiotrack_outlined,color: Colors.white70,size: 20.w,),

                                 Center(child: Text("Audio Exercises",textAlign:TextAlign.center, style: TextStyle(color: Colors.white70,fontSize: 20),)),
                              ],
                            )
                        ),
                      ),
                    ...
                    BouncingAnim(
                      onPress: (){Utils.push(context, AllVideos(languageId));},
                      child: Container(
                        width: 40.w,
                        height: 40.w,
                        child: Neumorphic(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children:  [
                                Icon(Icons.slow_motion_video_rounded,color: Colors.white70,size: 20.w,),
                                const Center(child: Padding(
                                  padding: EdgeInsets.only(left: 8,right: 8),
                                  child: Text("Video Exercises",textAlign: TextAlign.center, style: TextStyle(color: Colors.white70,fontSize: 20),),
                                )),
                              ],
                            )
                        ),
                ...
                BouncingAnim(
                  onPress: () async {
                    prDialog.show();
                    await postController.getAllPosts(languageId, 'document');
                    prDialog.dismiss();
                    //api call here
                    Utils.push(context, AllDocuments(languageId));
                  },
                  child: Container(
                    width: 40.w,
                    height: 40.w,
                    child: Neumorphic(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children:  [
                            Icon(Icons.description_outlined,color: Colors.white70,size: 20.w,),
                            const Center(child: Padding(
                              padding: EdgeInsets.only(left: 8,right: 8),
                              child: Text("Written Exercises",textAlign: TextAlign.center, style: TextStyle(color: Colors.white70,fontSize: 20),),
                            )),
                          ],
                        )
                    ),
